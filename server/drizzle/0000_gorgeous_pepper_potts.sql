...
CREATE TABLE "live_timers" (
	...
	"pomodoro_enabled" boolean DEFAULT false NOT NULL,
...
CREATE TABLE "projects" (
	...
	"code" text NOT NULL,
	"name" text NOT NULL,
	"color" text DEFAULT '#6B6359' NOT NULL,
	"client" text,
	"due" text,
	"created_by_id" text,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE "tasks" (
	...
	"est_h" real DEFAULT 1 NOT NULL,
	"logged_h" real DEFAULT 0 NOT NULL,
	"due" text,
	"project_id" text,
	"assignee_id" text,
	"created_by_id" text,
...
ALTER TABLE "live_timers" ADD CONSTRAINT "live_timers_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "live_timers" ADD CONSTRAINT "live_timers_task_id_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."tasks"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "task_sessions_user_from_idx" ON "task_sessions" USING btree ("user_id","from_at");--> statement-breakpoint
CREATE INDEX "tasks_assignee_col_idx" ON "tasks" USING btree ("assignee_id","column");--> statement-breakpoint
